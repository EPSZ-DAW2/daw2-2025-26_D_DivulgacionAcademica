...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-01-2026 a las 18:15:13
...
(7, 'Mis favoritos de Diseño', 'Recursos para inspiracion', 25, 15, '2026-01-09 15:06:02'),
(8, 'Estudio para Biología', 'Todo para el examen final', 19, 42, '2026-01-09 15:06:02');
...
INSERT INTO `documento` (`id`, `titulo`, `archivo_url`, `tipo_acceso`, `materiaId`, `autorId`, `usuario_subida_id`, `institucionId`) VALUES
(1, 'Plan de Estudios 2025', 'plan2025.pdf', 'publico', 1, 1, 1, 1),
(2, 'Tesis Doctoral: IA Generativa', 'tesis_ia.pdf', 'publico', 1, 1, 10, 1),
(3, 'Ejercicios de Álgebra Lineal', 'algebra_ej.pdf', 'privado', 9, 2, 8, 1),
(4, 'Guía Definitiva de React Hooks', 'react_guide.pdf', 'publico', 4, 4, 8, 2),
(5, 'Manual de Hacking Ético', 'hacking_v1.pdf', 'privado', 5, 3, 8, 2),
(6, 'Cheat Sheet PHP 8.2', 'php_resumen.pdf', 'publico', 4, 4, 4, 2),
(7, 'Laboratorio SQL Avanzado', 'sql_lab.pdf', 'privado', 6, 3, 4, 2),
(8, 'Phrasal Verbs List', 'phrasal_verbs.pdf', 'publico', 7, 5, 9, 3),
(9, 'German Grammar B1', 'deutsch_b1.pdf', 'privado', 8, 6, 2, 3),
(20, 'Introducción a la Edición Genética CRISPR', 'crispr_intro.pdf', 'publico', 16, 10, 1, 4),
(21, 'Historia del Renacimiento Italiano', 'renacimiento.pdf', 'privado', 17, 11, 1, 5),
(22, 'Redes Neuronales Convolucionales', 'cnn_guide.pdf', 'privado', 19, 12, 2, 6),
(23, 'Principios de Composición Visual', 'composicion.pdf', 'publico', 18, 11, 6, 5),
(24, 'Atlas Celular 2026', 'atlas_celular.pdf', 'privado', 15, 10, 4, 4),
(35, 'Leyes de Newton: Resumen y Ejercicios', 'newton_resumen.pdf', 'publico', 28, 14, 10, 1),
(36, 'Formulario de Física para Selectividad', 'formulario_fisica.pdf', 'publico', 21, 14, 9, 1),
(37, 'Tabla de Valencias para Imprimir', 'valencias.pdf', 'publico', 31, 15, 2, 1),
(38, 'Ejercicios de Ajuste de Reacciones', 'ajuste_reacciones.pdf', 'privado', 33, 15, 4, 1),
(39, 'Mi primer programa: Hola Mundo en Python', 'python_intro.pdf', 'publico', 25, 17, 3, 2),
(40, 'Guía de Bucles y Condicionales', 'bucles_java.pdf', 'privado', 1, 17, 4, 2),
(41, 'Eje Cronológico de la Guerra Civil', 'eje_guerra_civil.pdf', 'publico', 34, 18, 8, 1),
(42, 'Resumen Primera Guerra Mundial', 'ww1_resumen.pdf', 'publico', 35, 18, 10, 1),
(43, 'Conceptos básicos: Oferta y Demanda', 'oferta_demanda.pdf', 'publico', 38, 5, 6, 2),
(44, 'Balance de Situación: Ejercicio Resuelto', 'balance_ejemplo.pdf', 'privado', 37, 5, 9, 2),
(45, 'Comportamiento de la Luz', 'optica_intro.pdf', 'publico', 42, 20, 4, 1),
(46, 'Energía Nuclear: Ventajas y Riesgos', 'nuclear_debate.pdf', 'privado', 43, 14, 4, 1),
(47, 'Nomenclatura de Carbono', 'quimica_organica_1.pdf', 'publico', 45, 19, 8, 4),
(48, 'Manual de Seguridad en Laboratorio', 'safety_lab.pdf', 'publico', 47, 15, 6, 1),
(49, 'Creando tu primera App en Android', 'android_start.pdf', 'privado', 40, 21, 8, 2),
(50, 'Árboles y Grafos en Python', 'estructuras_datos.pdf', 'privado', 41, 21, 10, 2),
(51, 'La vida en Roma', 'roma_antigua.pdf', 'publico', 48, 18, 6, 1),
(52, 'Impacto de la Máquina de Vapor', 'revolucion_ind.pdf', 'publico', 50, 18, 7, 1),
(53, 'Estrategias de Marketing 2026', 'marketing_trends.pdf', 'publico', 52, 22, 9, 7),
(54, 'Plan General Contable', 'pgc_resumen.pdf', 'privado', 53, 5, 3, 2),
(55, 'Gramática Francesa A1: Lecciones Básicas', 'fr_grammar_a1.pdf', 'publico', 69, 6, 6, 3),
(56, 'Vocabulario de Viajes: París', 'fr_vocab_travel.pdf', 'publico', 69, 6, 10, 3),
(57, 'Escritura Hiragana: Cuaderno de Práctica', 'jp_hiragana.pdf', 'privado', 70, 5, 2, 3),
(58, 'Saludos y Cortesía en Japón', 'jp_culture.pdf', 'publico', 70, 5, 1, 3),
(59, 'Italiano para Gastronomía', 'it_food_vocab.pdf', 'publico', 71, 6, 6, 3),
(60, 'Conjugación de Verbos Italianos', 'it_verbs.pdf', 'privado', 71, 6, 8, 3),
(61, 'Introducción a los Límites', 'calc_limites.pdf', 'publico', 72, 14, 10, 1),
(62, 'Derivadas paso a paso', 'calc_derivadas.pdf', 'privado', 72, 14, 5, 1),
(63, 'Vectores en el Espacio 3D', 'geo_vectores.pdf', 'publico', 73, 20, 4, 1),
(64, 'Identidades Trigonométricas Fundamentales', 'trig_sheet.pdf', 'publico', 74, 20, 5, 1),
(65, 'Cálculo de Interés Compuesto', 'fin_interest.xlsx', 'privado', 75, 16, 4, 2),
(66, 'Amortización de Préstamos: Guía', 'fin_loans.pdf', 'publico', 75, 16, 4, 2),
(67, 'Teoría del Color: RGB vs CMYK', 'color_theory.pdf', 'publico', 76, 11, 8, 5),
(68, 'Psicología del Color en Publicidad', 'color_psych.pdf', 'privado', 76, 11, 6, 5),
(69, 'La Regla de los Tercios en Fotografía', 'photo_composition.pdf', 'publico', 77, 11, 8, 5),
(70, 'Guía de ISO, Apertura y Velocidad', 'photo_exposure.pdf', 'privado', 77, 11, 2, 5),
(71, 'Introducción a la Producción Musical', 'music_intro.pdf', 'publico', 78, 11, 3, 5),
(72, 'Uso de Compresores y EQ', 'music_mix.mp4', 'privado', 78, 11, 9, 5),
(73, 'Fauna Ibérica: Mamíferos', 'zoo_mammals.pdf', 'publico', 79, 10, 7, 4),
(74, 'Invertebrados Marinos del Mediterráneo', 'zoo_marine.pdf', 'privado', 79, 10, 5, 4),
(75, 'Estrategias de Economía Circular', 'eco_circular.pdf', 'publico', 80, 19, 6, 4),
(76, 'Impacto del Cambio Climático 2026', 'eco_climate.pdf', 'publico', 80, 19, 3, 4),
(77, 'Neurotransmisores y Sinapsis', 'neuro_synapse.pdf', 'privado', 81, 10, 5, 4),
(78, 'Plasticidad Cerebral: Resumen', 'neuro_plasticity.pdf', 'publico', 81, 10, 9, 4);
...
ALTER TABLE `documento`
  ...
  ADD KEY `fk_doc_usuario_subida` (`usuario_subida_id`);
...
ALTER TABLE `documento`
  ...
  ADD CONSTRAINT `fk_doc_usuario_subida` FOREIGN KEY (`usuario_subida_id`) REFERENCES `usuario` (`id`) ON DELETE SET NULL;
